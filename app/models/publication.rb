...
class Publication < ApplicationRecord
  ...
  scope :doi_nil_verification, -> { activity_insight_oa_publication.where(doi_verified: nil) }
  scope :needs_doi_verification, -> { doi_nil_verification.where.not(oa_workflow_state: 'automatic DOI verification pending').or(doi_nil_verification.where(oa_workflow_state: nil)) }
