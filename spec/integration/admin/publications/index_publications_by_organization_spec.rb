  ...
  context 'when the current user is an admin', :js do
    ...
    describe 'navigating to the publication list from an organization' do
      ...
      it 'loads the list of publications' do
        expect(page).to have_current_path RailsAdmin.railtie_routes_url_helpers.index_publications_by_organization_path(model_name: :publication), ignore_query: true
    ...
    describe 'exporting found publications' do
      ...
      it 'shows the correct page for selecting export options' do
        expect(page).to have_current_path RailsAdmin.railtie_routes_url_helpers.export_publications_by_organization_path(model_name: :publication), ignore_query: true
