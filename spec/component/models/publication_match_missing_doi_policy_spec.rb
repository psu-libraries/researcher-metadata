...
describe PublicationMatchMissingDoiPolicy do
  ...
  describe '#ok_to_merge?' do
    ...
    context 'when publication1 and publication2 are exactly the same and...' do
      context 'publication2 has a doi but publication1 does not' do
        before do
      ...
      context 'the title for publication2 is at least a 90% match to the title for publication1' do
        before do
          publication2.update title: 'The Generic Title That Is Nearly Identical for Publication 2'
          publication1.update title: 'The Generic Title That Is Nearly Identical for Publication 1'
      ...
      context 'the titles appended to the secondary titles for publication1 and publication2 do not pass matching' do
        ...
        context 'the secondary title does not match' do
          before do
            publication2.update secondary_title: 'Some other secondary title'
          end
