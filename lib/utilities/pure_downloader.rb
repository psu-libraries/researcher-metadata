...
class PureDownloader
  def download_pure_orgs
    ...
    first_org_result = `curl -X GET --header 'Accept: application/json' --header 'api-key: #{api_key}' 'https://pennstate.pure.elsevier.com/ws/api/515/organisational-units?navigationLink=false&size=1&offset=0'`

    total_orgs = JSON.parse(first_org_result)['count']

    all_orgs_results = `curl -X GET --header 'Accept: application/json' --header 'api-key: #{api_key}' 'https://pennstate.pure.elsevier.com/ws/api/515/organisational-units?navigationLink=false&size=#{total_orgs}&offset=0'`
  ...
  def download_pure_users
    ...
    first_person_result = `curl -X GET --header 'Accept: application/json' --header 'api-key: #{api_key}' 'https://pennstate.pure.elsevier.com/ws/api/515/persons?navigationLink=false&size=1&offset=0'`

    total_persons = JSON.parse(first_person_result)['count']

    all_persons_results = `curl -X GET --header 'Accept: application/json' --header 'api-key: #{api_key}' 'https://pennstate.pure.elsevier.com/ws/api/515/persons?navigationLink=false&size=#{total_persons}&offset=0'`
  ...
  def download_pure_pubs
    ...
    first_pub_result = `curl -X GET --header 'Accept: application/json' --header 'api-key: #{api_key}' 'https://pennstate.pure.elsevier.com/ws/api/515/research-outputs?navigationLink=false&size=1&offset=0'`
    ...
    1.upto(total_pages) do |i|
      ...
      pubs = `curl -X GET --header 'Accept: application/json' --header 'api-key: #{api_key}' 'https://pennstate.pure.elsevier.com/ws/api/515/research-outputs?navigationLink=false&size=#{page_size}&offset=#{offset}'`
