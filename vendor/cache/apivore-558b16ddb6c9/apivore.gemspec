...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<actionpack>.freeze, [">= 4", "< 7"])
    s.add_development_dependency(%q<activesupport>.freeze, [">= 4", "< 7"])
    ...
    s.add_dependency(%q<actionpack>.freeze, [">= 4", "< 7"])
    s.add_dependency(%q<activesupport>.freeze, [">= 4", "< 7"])
